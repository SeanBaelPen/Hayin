...
class _HomePageState extends ConsumerState<HomePage> {
  ...
  Future<void> checkLoc(restauData, location) async {
              ...
              children: [
                ...
                BottomNavigationBar(
                  ...
                  onTap: (index) async {
                    ...
                    String? storedDateTime = prefs.getString('currentDateTime');

                    if (storedDateTime != null) {
                      DateTime parsedDate = DateTime.parse(storedDateTime);

                      if (DateTime.now().difference(parsedDate) >=
                          Duration(days: 1)) {
                        checkLoc(restauData, location);
                      } else {
                        Fluttertoast.showToast(
                            msg: "You can only claim points once a day");
                      }
                    } else {
                      checkLoc(restauData, location);
                    }
